...
output "app1_mig_id" {
  ...
  value       = google_compute_region_instance_group_manager.app1.id
}

output "app1_mig_instance_group" {
  description = "The full URL of the instance group created by the manager"
  value       = google_compute_region_instance_group_manager.app1.instance_group
}

output "app1_mig_self_link" {
  description = "The URL of the created resource"
  value       = google_compute_region_instance_group_manager.app1.self_link
}
...
output "app1_mig_status" {
  ...
  value       = google_compute_region_instance_group_manager.app1.status
}
